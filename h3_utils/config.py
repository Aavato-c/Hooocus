...
class InptaintOptions(BaseModel):
    ...
    inpaint_strength: float = Field(1.0, description="The default inpaint strength to use.", ge=0.0, le=1.0)
...
class _InitialImageGenerationParams(BaseModel):
    ...
    checkpoint_downloads: Optional[dict[str, str]] = Field({},description="The default checkpoint downloads to use.",)
    ...
    embeddings_downloads: dict[str, str] = Field({},description="The default embeddings downloads to use.",)
    ...
    input_images: Optional[List[InputImageType]] = None
    input_image_url: Optional[str] = None
