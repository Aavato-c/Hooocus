...
class ClipVisionModel():
    def __init__(self, json_config):
        ...
        offload_device = unavoided_globals.model_management.text_encoder_offload_device()
        self.dtype = unavoided_globals.model_management.text_encoder_dtype(self.load_device)
    ...
    def encode_image(self, image):
        ...
        outputs = Output()
        outputs["last_hidden_state"] = out[0].to(unavoided_globals.model_management.intermediate_device())
        outputs["image_embeds"] = out[2].to(unavoided_globals.model_management.intermediate_device())
        outputs["penultimate_hidden_states"] = out[1].to(unavoided_globals.model_management.intermediate_device())
        return outputs
