...
def prepare_sampling(model, noise_shape, positive, negative, noise_mask):
    ...
    unavoided_globals.model_management.load_models_gpu([model] + models, model.memory_required([noise_shape[0] * 2] + list(noise_shape[1:])) + inference_memory)
...
def sample(model, noise, steps, cfg, sampler_name, scheduler, positive, negative, latent_image, denoise=1.0, disable_noise=False, start_step=None, last_step=None, force_full_denoise=False, noise_mask=None, sigmas=None, callback=None, disable_pbar=False, seed=None):
    ...
    samples = samples.to(unavoided_globals.model_management.intermediate_device())
