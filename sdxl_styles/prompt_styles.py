...
class PromptStyle(BaseModel):
    ...
    def __init__(self, *args, **kwargs):
        self.imagepath = f"{sample_img_path}{self.style_name.lower()}.jpg"


class Fooocus:

    Fooocus_Enhance = PromptStyle(
        style_name="Fooocus_Enhance",
    ...
    Fooocus_Semi_Realistic = PromptStyle(
        style_name="Fooocus_Semi_Realistic",
    ...
    Fooocus_Masterpiece = PromptStyle(
        style_name="Fooocus_Masterpiece",
...
class Diva:
    ...
    Abstract_Expressionism = PromptStyle(
        style_name="Abstract_Expressionism",
    ...
    Bauhaus_Style_Poster = PromptStyle(
        style_name="Bauhaus_Style_Poster",
    ...
    Blueprint_Schematic_Drawing = PromptStyle(
        style_name="Blueprint_Schematic_Drawing",
    ...
    Dark_Moody_Atmosphere = PromptStyle(
        style_name="Dark_Moody_Atmosphere",
    ...
    Dripping_Paint_Splatter_Art = PromptStyle(
        style_name="Dripping_Paint_Splatter_Art",
    ...
    Faded_Polaroid_Photo = PromptStyle(
        style_name="Faded_Polaroid_Photo",
    ...
    Light_Cheery_Atmosphere = PromptStyle(
        style_name="Light_Cheery_Atmosphere",
    ...
    Ornate_and_Intricate = PromptStyle(
        style_name="Ornate_and_Intricate",
    ...
    Tranquil_Relaxing_Atmosphere = PromptStyle(
        style_name="Tranquil_Relaxing_Atmosphere",
...
class Mark_K3nt3l:
    MK_Chromolithography = PromptStyle(
        style_name="MK_Chromolithography",
    ...
    MK_Cross_Processing_Print = PromptStyle(
        style_name="MK_Cross_Processing_Print",
    ...
    MK_Dufaycolor_Photograph = PromptStyle(
        style_name="MK_Dufaycolor_Photograph",
    ...
    MK_Color_Sketchnote = PromptStyle(
        style_name="MK_Color_Sketchnote",
    ...
    MK_Cibulak_Porcelain = PromptStyle(
        style_name="MK_Cibulak_Porcelain",
    ...
    MK_Blacklight_Paint = PromptStyle(
        style_name="MK_Blacklight_Paint",
    ...
    MK_vintage_airline_poster = PromptStyle(
        style_name="MK_vintage_airline_poster",
    ...
    MK_vintage_travel_poster = PromptStyle(
        style_name="MK_vintage_travel_poster",
    ...
    MK_illuminated_manuscript = PromptStyle(
        style_name="MK_illuminated_manuscript",
    ...
    MK_kalighat_painting = PromptStyle(
        style_name="MK_kalighat_painting",
    ...
    MK_madhubani_painting = PromptStyle(
        style_name="MK_madhubani_painting",
    ...
    MK_pichwai_painting = PromptStyle(
        style_name="MK_pichwai_painting",
    ...
    MK_patachitra_painting = PromptStyle(
        style_name="MK_patachitra_painting",
    ...
    MK_samoan_art_inspired = PromptStyle(
        style_name="MK_samoan_art_inspired",
    ...
    MK_ron_english_style = PromptStyle(
        style_name="MK_ron_english_style",
    ...
    MK_shepard_fairey_style = PromptStyle(
        style_name="MK_shepard_fairey_style",
...
class MRE:
    mre_cinematic_dynamic = PromptStyle(
        style_name="mre_cinematic_dynamic",
    ...
    mre_spontaneous_picture = PromptStyle(
        style_name="mre_spontaneous_picture",
    ...
    mre_artistic_vision = PromptStyle(
        style_name="mre_artistic_vision",
    ...
    mre_surreal_painting = PromptStyle(
        style_name="mre_surreal_painting",
    ...
    mre_dynamic_illustration = PromptStyle(
        style_name="mre_dynamic_illustration",
    ...
    mre_ancient_illustration = PromptStyle(
        style_name="mre_ancient_illustration",
    ...
    mre_lyrical_geometry = PromptStyle(
        style_name="mre_lyrical_geometry",
    ...
    mre_sumi_e_symbolic = PromptStyle(
        style_name="mre_sumi_e_symbolic",
    ...
    mre_sumi_e_detailed = PromptStyle(
        style_name="mre_sumi_e_detailed",
...
class TWIRI:
    ...
    ads_fashion_editorial = PromptStyle(
        style_name="ads_fashion_editorial",
    ...
    ads_food_photography = PromptStyle(
        style_name="ads_food_photography",
    ...
    ads_gourmet_food_photography = PromptStyle(
        style_name="ads_gourmet_food_photography",
    ...
    artstyle_abstract_expressionism = PromptStyle(
        style_name="artstyle_abstract_expressionism",
    ...
    artstyle_art_nouveau = PromptStyle(
        style_name="artstyle_art_nouveau",
    ...
    artstyle_constructivist = PromptStyle(
        style_name="artstyle_constructivist",
    ...
    artstyle_expressionist = PromptStyle(
        style_name="artstyle_expressionist",
    ...
    artstyle_impressionist = PromptStyle(
        style_name="artstyle_impressionist",
    ...
    artstyle_pointillism = PromptStyle(
        style_name="artstyle_pointillism",
    ...
    artstyle_psychedelic = PromptStyle(
        style_name="artstyle_psychedelic",
    ...
    artstyle_renaissance = PromptStyle(
        style_name="artstyle_renaissance",
    ...
    artstyle_surrealist = PromptStyle(
        style_name="artstyle_surrealist",
    ...
    futuristic_biomechanical_cyberpunk = PromptStyle(
        style_name="futuristic_biomechanical_cyberpunk",
    ...
    futuristic_cybernetic = PromptStyle(
        style_name="futuristic_cybernetic",
    ...
    futuristic_cybernetic_robot = PromptStyle(
        style_name="futuristic_cybernetic_robot",
    ...
    futuristic_cyberpunk_cityscape = PromptStyle(
        style_name="futuristic_cyberpunk_cityscape",
    ...
    futuristic_futuristic = PromptStyle(
        style_name="futuristic_futuristic",
    ...
    futuristic_retro_cyberpunk = PromptStyle(
        style_name="futuristic_retro_cyberpunk",
    ...
    futuristic_retro_futurism = PromptStyle(
        style_name="futuristic_retro_futurism",
    ...
    futuristic_vaporwave = PromptStyle(
        style_name="futuristic_vaporwave",
    ...
    game_cyberpunk_game = PromptStyle(
        style_name="game_cyberpunk_game",
    ...
    game_rpg_fantasy_game = PromptStyle(
        style_name="game_rpg_fantasy_game",
    ...
    papercraft_kirigami = PromptStyle(
        style_name="papercraft_kirigami",
    ...
    papercraft_paper_mache = PromptStyle(
        style_name="papercraft_paper_mache",
    ...
    papercraft_paper_quilling = PromptStyle(
        style_name="papercraft_paper_quilling",
    ...
    papercraft_papercut_collage = PromptStyle(
        style_name="papercraft_papercut_collage",
    ...
    papercraft_papercut_shadow_box = PromptStyle(
        style_name="papercraft_papercut_shadow_box",
    ...
    papercraft_stacked_papercut = PromptStyle(
        style_name="papercraft_stacked_papercut",
    ...
    papercraft_thick_layered_papercut = PromptStyle(
        style_name="papercraft_thick_layered_papercut",
    ...
    photo_iphone_photographic = PromptStyle(
        style_name="photo_iphone_photographic",
    ...
    photo_long_exposure = PromptStyle(
        style_name="photo_long_exposure",
